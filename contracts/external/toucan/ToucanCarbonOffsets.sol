    ...
    ToucanCarbonOffsetsStorage
{
    ...
    modifier whenNotPaused() {
        address ToucanCarbonOffsetsFactoryAddress = IToucanContractRegistryTest(
            contractRegistry
    ...
    {
        CarbonProjectTypes.ProjectData memory projectData;
        CarbonProjectVintageTypes.VintageData memory vintageData;
    ...
    {
        address pc = IToucanContractRegistryTest(contractRegistry)
            .carbonProjectsAddress();
        address vc = IToucanContractRegistryTest(contractRegistry)
            .carbonProjectVintagesAddress();

        CarbonProjectVintageTypes.VintageData
            memory vintageData = ICarbonProjectVintages(vc)
                .getProjectVintageDataByTokenId(projectVintageTokenId);
        CarbonProjectTypes.ProjectData memory projectData = ICarbonProjects(pc)
    ...
    function onERC721Received(
        ...
        (
            ...
            uint256 quantity,
            CarbonOffsetBatchesTypes.RetirementStatus status
        ...
        require(
            status == CarbonOffsetBatchesTypes.RetirementStatus.Confirmed,
        ...
        ToucanCarbonOffsetsFactory tco2Factory = ToucanCarbonOffsetsFactory(
            IToucanContractRegistryTest(contractRegistry)
                .toucanCarbonOffsetsFactoryAddress()
        );
        ...
        returns (uint256 retirementEventId)
    {
        ...
        address certAddr = IToucanContractRegistryTest(contractRegistry)
        ...
        returns (uint256 retirementEventId)
    {
        ...
        address TCO2FactoryAddress = IToucanContractRegistryTest(
            contractRegistry
        ).toucanCarbonOffsetsFactoryAddress();
