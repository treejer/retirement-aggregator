    ...
    ToucanCarbonOffsetsFactoryStorage
{
        ...
        whenNotPaused
    {
        ...
        ToucanCarbonOffsets proxyTCO2 = new ToucanCarbonOffsets(
        ...
        IToucanContractRegistryTest(contractRegistry).addERC20(
            address(proxyTCO2)
        );
    ...
    function increaseTotalRetired(uint256 amount) external {
        bool isTCO2 = IToucanContractRegistryTest(contractRegistry).checkERC20(
            msg.sender
        );
