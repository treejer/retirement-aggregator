    ...
    CarbonOffsetBatchesStorage
{
        ...
        whenNotPaused
    {
        ...
        nftList[tokenId].status = CarbonOffsetBatchesTypes
            .RetirementStatus
            .Confirmed;
    ...
    function confirmRetirementWithVintage(
        ...
        require(
            nftList[tokenId].status !=
                CarbonOffsetBatchesTypes.RetirementStatus.Confirmed,
    ...
    function mintEmptyBatch(address to) external virtual whenNotPaused {
        ...
        nftList[newItemId].status = CarbonOffsetBatchesTypes
            .RetirementStatus
            .Pending;
    ...
    function updateBatchWithData(
        ...
        if (
            nftList[tokenId].status ==
            CarbonOffsetBatchesTypes.RetirementStatus.Rejected
        ) {
            nftList[tokenId].status = CarbonOffsetBatchesTypes
                .RetirementStatus
                .Pending;
    ...
    function getConfirmationStatus(uint256 tokenId)
        ...
        virtual
        override
        returns (CarbonOffsetBatchesTypes.RetirementStatus)
    {
    ...
    function getBatchNFTData(uint256 tokenId)
        ...
        returns (
            uint256,
            uint256,
            CarbonOffsetBatchesTypes.RetirementStatus
        )
    {
        return (
    ...
    function fractionalize(uint256 tokenId) external virtual {
        ...
        address ERC20Factory = IToucanContractRegistryTest(contractRegistry)
