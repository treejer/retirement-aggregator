    ...
    BaseCarbonTonneStorage
{
    ...
    function checkEligible(address erc20Addr)
        ...
        returns (bool)
    {
        bool isToucanContract = IToucanContractRegistryTest(contractRegistry)
        ...
        returns (bool)
    {
        ...
        (projectData, vintageData) = IToucanCarbonOffsets_2(erc20Addr)
            .getAttributes();
    ...
    function redeemAndBurn(address tco2, uint256 amount) external {
        ...
        IToucanCarbonOffsets_2(tco2).burnFrom(msg.sender, amount);
    }
